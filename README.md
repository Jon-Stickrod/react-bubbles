...
A token is used to make security decisions as to weather a user is able to acsess something or not.
- [ ] What steps can you take in your web apps to keep your data secure?
store passwords on protected data base, making sure no user infor mation is being stored in the browser without their knowledge.
- [ ] Describe how web servers work.
process incoming network requests over HTTP and several protocals. web servers store, process, and deliver web pages to clients.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
 Create, Read (Get), Update (put), Delete 
